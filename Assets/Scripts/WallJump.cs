...
public class WallJump : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.DrawRay(transform.position, Vector3.left * 0.75f, Color.blue);
        Debug.DrawRay(transform.position, Vector3.right * 0.75f, Color.red);
        Debug.DrawRay(transform.position, Vector3.down * 1.25f, Color.black);
        Debug.DrawRay(transform.position, -1 * Vector3.down * 1.25f, Color.yellow);
    }
